...
def add_disc_sum_rew(trajectories, gamma):
    ...
    for trajectory in trajectories:
		...
		#rewards = trajectory['rewards']*self.std_rewards # make running stdev variable
		#rewards = trajectory['rewards']*0.01 # what I saw in DDPG
...
if __name__ == "__main__":
    ...
    parser.add_argument('-v', '--policy_logvar', type=float,
                        ...
                        default=-1.0)
    parser.add_argument('-p', '--print_results', type=bool,
                        help='Save graphs: learning graphs and final policy graph',
                        default=False)
